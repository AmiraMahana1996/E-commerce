...
export default function LearningDetails() {
  ...
  const handleSubmit = async (event) => {
    ...
    await axios.put(
      `http://localhost:5000/api/learning/add-topic/${path[4]}`,
      formData
    );
  ...
  return (
    <>
      <Typography color="success" align="center" level="h2">
        {name}
      </Typography>
      <Dropdown
        sx={{
            ...
            <Card variant="soft">
              <CardContent>
                ...
                <Button type="secondary">
                  <a href={`/cms/learning/learning-details/${path[4]}/${item._id}`} className="continuebtn">
                    Continue..
                  </a>
                </Button>
              </CardContent>
